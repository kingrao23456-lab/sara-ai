...
export default function App() {
  ...
  return (
    <div className="min-h-dvh h-dvh bg-black text-white font-sans selection:bg-pink-500/30 overflow-hidden flex flex-col items-center justify-center p-6 relative">
      {/* Background Glow */}
